...
FreeAgent = (function() {
  ...
  FreeAgent.prototype.refreshToken = function(refresh_token, client_id, client_secret, callback) {
    ...
    return request.post(options, function(error, data, body) {
      console.log(body);
  ...
  FreeAgent.prototype.getContacts = function(projectUri, optionsOrCallback, callback) {
    var params;
    params = this._processParams(optionsOrCallback, callback);
    return this._getRequest('contacts/' + projectUri, params.options, params.callback);
  };
